...
function vergiHesapla(){
    ...
    // a for loop for select car force 
    ...
    // a loop for return car year list.
    ...
    // We defined tax that customer will pay according to car type.
    ...
    // We defined tax that customer will pay according to car force.
    ...
    // a condition -> if car year  less than 2000 this cındition does 25 turkish lira discount.
    ...
    document.getElementById("sonuc").innerHTML="Ödenecek Vergi : "+odenecekVergi;
}